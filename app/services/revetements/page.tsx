        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
              <span className="text-white">SARL FCR : spécialiste revêtements sols et murs pour<br />
              ...
              <div>
                <div className="flex items-center mb-6">
                  <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mr-4 flex-shrink-0">
                    <img src="/paint-roller copy.png" alt="Revêtements" className="h-8 w-8" />
                  </div>
                  <div>
                    <h2 className="text-2xl font-bold mb-2" style={{ color: '#3e9dd3' }}>
                      En quoi consistent les revêtements sols et murs ?
                    </h2>
                    <span className="text-sm font-medium" style={{ color: '#3e9dd3' }}>Revêtements sols et murs</span>
                  </div>
                </div>
                <div className="space-y-4 text-gray-700">
                  <p className="text-gray-700">
                    Solutions complètes de revêtements sols et murs, réalisées par un spécialiste en Île-de-France depuis 13 ans.
                  </p>
                </div>
              </div>
              <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="order-1 lg:order-2">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-bold" style={{ color: '#3e9dd3' }}>Peintures des murs et plafonds</h3>
                </div>
                <div className="space-y-4 text-gray-700">
                  <ul className="list-disc list-inside space-y-2">
                    <li>Peinture décorative pour sublimer vos espaces</li>
          ...
          <div className="mb-20">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                <div className="flex items-center mb-4">
                  <div className="w-3 h-3 rounded-full mr-3 mt-2 flex-shrink-0" style={{ backgroundColor: '#3e9dd3' }}></div>
                  <h3 className="text-xl font-bold" style={{ color: '#3e9dd3' }}>Revêtements sols / murs</h3>
                </div>
                <div className="space-y-4 text-gray-700">
                  <ul className="list-disc list-inside space-y-2">
                    <li>Faïence</li>
          ...
          <div className="bg-gray-100 p-8 rounded-lg border-2" style={{ borderColor: '#3e9dd3' }}>
            <div className="text-center">
              ...
              <p className="text-gray-700 mb-6">
                ...
                <strong style={{ color: '#3e9dd3' }}> revêtements sols et murs</strong>.
              </p>
