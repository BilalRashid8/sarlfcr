...
export default function Project10() {
  ...
  const projectImages = [
    { src: '/placeholder-project.jpg', alt: 'Projet 10 - Image 1' },
    { src: '/placeholder-project.jpg', alt: 'Projet 10 - Image 2' },
    { src: '/placeholder-project.jpg', alt: 'Projet 10 - Image 3' },
  ];
