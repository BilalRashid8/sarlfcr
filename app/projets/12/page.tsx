...
export default function Project12() {
  ...
  const projectImages = [
    { src: '/placeholder-project.jpg', alt: 'Projet 12 - Image 1' },
    { src: '/placeholder-project.jpg', alt: 'Projet 12 - Image 2' },
    { src: '/placeholder-project.jpg', alt: 'Projet 12 - Image 3' },
  ];
